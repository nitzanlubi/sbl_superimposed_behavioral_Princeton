...
function subs_rand_varsRoutineBegin(snapshot) {
  return async function () {
    ...
    subs_rand_varsComponents.forEach( function(thisComponent) {
...
function set_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    set_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_scrRoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_scrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst2RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function create_runs_stim_divRoutineBegin(snapshot) {
  return async function () {
    ...
    create_runs_stim_divComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function show_rest_screenLoopBegin(show_rest_screenLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    show_rest_screen.forEach(function() {
...
function set_rowsRoutineBegin(snapshot) {
  return async function () {
    ...
    set_rowsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function scene_confidenceRoutineBegin(snapshot) {
  return async function () {
    ...
    scene_confidenceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function is_lastRoutineBegin(snapshot) {
  return async function () {
    ...
    is_lastComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function rest_between_runsRoutineBegin(snapshot) {
  return async function () {
    ...
    rest_between_runsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_end_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    ret_end_screenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function forked_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    forked_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
