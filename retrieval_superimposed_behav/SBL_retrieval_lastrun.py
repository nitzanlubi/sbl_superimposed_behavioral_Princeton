...
expName = 'SBL_superimposed_retrieval'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/nitzanlubi/Library/CloudStorage/GoogleDrive-nitzanlubi@gmail.com/My Drive/Lab/schema_based_learning/tasks/retrieval_superimposed_behav/SBL_retrieval_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    scene_J1_lbl = df.loc[df['scene_stimulus']=='J1','scene_label'].values[0]
    scene_J2_lbl = df.loc[df['scene_stimulus']=='J2','scene_label'].values[0]
    scene_U1_lbl = df.loc[df['scene_stimulus']=='U1','scene_label'].values[0]
    scene_U2_lbl = df.loc[df['scene_stimulus']=='U2','scene_label'].values[0]
    ...
    stim_list = 'stimuli/stim_lists/stimuli_list_sub_' + str(subnum) + '_run_1.csv'
    ...
    continueRoutine = True
    # update component parameters for each repeat
    image1.setImage('stimuli/scenes/scene_J1.png')
    image2.setImage('stimuli/scenes/scene_J2.png')
    image3.setImage('stimuli/scenes/scene_U1.png')
    image4.setImage('stimuli/scenes/scene_U2.png')
    textbox1.reset()
