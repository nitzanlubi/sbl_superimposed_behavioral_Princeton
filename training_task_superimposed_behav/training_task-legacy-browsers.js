...
function get_sub_varsRoutineBegin(snapshot) {
  return async function () {
    ...
    get_sub_varsComponents.forEach( function(thisComponent) {
...
function part1_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    part1_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function skip_to_part4_debugLoopBegin(skip_to_part4_debugLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    skip_to_part4_debug.forEach(function() {
...
function skip_loop_debugLoopBegin(skip_loop_debugLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    skip_loop_debug.forEach(function() {
...
function visualization_loopLoopBegin(visualization_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    visualization_loop.forEach(function() {
...
function trials_retrievalLoopBegin(trials_retrievalLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    trials_retrieval.forEach(function() {
...
function part1_instructions_2RoutineBegin(snapshot) {
  return async function () {
    ...
    part1_instructions_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part1_compareRoutineBegin(snapshot) {
  return async function () {
    ...
    part1_compareComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part2_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    part2_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part2_questionRoutineBegin(snapshot) {
  return async function () {
    ...
    part2_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part2_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    part2_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part3_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    part3_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function reset_vis_varsRoutineBegin(snapshot) {
  return async function () {
    ...
    reset_vis_varsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function skip_answered_questionsRoutineBegin(snapshot) {
  return async function () {
    ...
    skip_answered_questionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part3_visualizeRoutineBegin(snapshot) {
  return async function () {
    ...
    part3_visualizeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part3_rateRoutineBegin(snapshot) {
  return async function () {
    ...
    part3_rateComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part3_questionRoutineBegin(snapshot) {
  return async function () {
    ...
    part3_questionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function study_againRoutineBegin(snapshot) {
  return async function () {
    ...
    study_againComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function msg_next_sceneRoutineBegin(snapshot) {
  return async function () {
    ...
    msg_next_sceneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function part4_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    part4_instructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function enc_instruction_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    enc_instruction_screenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function enc_inst_2RoutineBegin(snapshot) {
  return async function () {
    ...
    enc_inst_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function get_stim_listRoutineBegin(snapshot) {
  return async function () {
    ...
    get_stim_listComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function blank1000_2RoutineBegin(snapshot) {
  return async function () {
    ...
    blank1000_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_genRoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_genComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_1RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_2RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_3RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_4RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_5RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ret_inst_6RoutineBegin(snapshot) {
  return async function () {
    ...
    ret_inst_6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function item_imagine_sceneRoutineBegin(snapshot) {
  return async function () {
    ...
    item_imagine_sceneComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function select_contextRoutineBegin(snapshot) {
  return async function () {
    ...
    select_contextComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function context_confidenceRoutineBegin(snapshot) {
  return async function () {
    ...
    context_confidenceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function select_scene_nameRoutineBegin(snapshot) {
  return async function () {
    ...
    select_scene_nameComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function select_confidenceRoutineBegin(snapshot) {
  return async function () {
    ...
    select_confidenceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function blank3000RoutineBegin(snapshot) {
  return async function () {
    ...
    blank3000Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_screen_2RoutineBegin(snapshot) {
  return async function () {
    ...
    end_screen_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
