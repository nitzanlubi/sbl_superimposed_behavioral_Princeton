run_3.csv'},
    {'name': 'stimuli/stim_lists/stimuli_list_sub_101_set_1_run_2.csv', 'path': 'stimuli/stim_lists/stimuli_list_sub_101_set_1_run_2.csv'},
    ...
    {'name': 'stimuli/stim_lists/stimuli_list_sub_100_set_2_run_3.csv', 'path': 'stimuli/stim_lists/stimuli_list_sub_100_set_2_run_3.csv'},
    {'name': 'stimuli/stim_lists/stimuli_list_sub_100_set_2_run_2.csv', 'path': 'stimuli/stim_lists/stimuli_list_sub_100_set_2_run_2.csv'},
    ...
    {'name': 'stimuli/stim_lists/stimuli_list_sub_100_set_1_run_3.csv', 'path': 'stimuli/stim_lists/stimuli_list_sub_100_set_1_run_3.csv'},
    {'name': 'stimuli/stim_lists/stimuli_list_sub_100_set_1_run_2.csv', 'path': 'stimuli/stim_lists/stimuli_list_sub_100_set_1_run_2.csv'},
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://run.pavlovia.org/nitzanlubi/arithmetic_task_exp', '');


  
  psychoJS.experiment.dataFileName = (("." + "/") + `data/${expInfo["participant"]}_${expInfo["delay"]}_${expInfo["session"]}_${expName}_${expInfo["date"]}`);
...
var key_welcome;
var instruction_keysClock;
var text_keys;
var key_resp_keysInst;
var blank2000Clock;
var text_2;
...
async function experimentInit() {
  ...
  instruction_keysClock = new util.Clock();
  text_keys = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_keys',
    text: '',
    font: 'Open Sans',
  ...
  key_resp_keysInst = new core.Keyboard({psychoJS: psychoJS, clock: new util.Clock(), waitForStart: true});
  ...
  image_scene = new visual.ImageStim({
    ...
    anchor : 'center',
    ori : 0.0, pos : [0, 0], size : [1920, 1020],
...
function get_relatedness_keysRoutineBegin(snapshot) {
  return async function () {
    ...
    get_relatedness_keysComponents.forEach( function(thisComponent) {
...
function instructions_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    instructions_screenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
var _key_resp_keysInst_allKeys;
var instruction_keysComponents;
function instruction_keysRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'instruction_keys' ---
    t = 0;
    instruction_keysClock.reset(); // clock
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('instruction_keys.started', globalClock.getTime());
    text_keys.setText(instruction_text);
    key_resp_keysInst.keys = undefined;
    key_resp_keysInst.rt = undefined;
    _key_resp_keysInst_allKeys = [];
    // keep track of which components have finished
    instruction_keysComponents = [];
    instruction_keysComponents.push(text_keys);
    instruction_keysComponents.push(key_resp_keysInst);
    
    instruction_keysComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instruction_keysRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'instruction_keys' ---
    // get current time
    t = instruction_keysClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
    
    // *text_keys* updates
    if (t >= 0.0 && text_keys.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      text_keys.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && key_resp_keysInst.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      key_resp_keysInst.tStart = t;  // (not accounting for frame time here)
      key_resp_keysInst.frameNStart = frameN;  // exact frame index
      
      // keyboard checking is just starting
      psychoJS.window.callOnFlip(function() { key_resp_keysInst.clock.reset(); });  // t=0 on next screen flip
      psychoJS.window.callOnFlip(function() { key_resp_keysInst.start(); }); // start on screen flip
      psychoJS.window.callOnFlip(function() { key_resp_keysInst.clearEvents(); });
    }
    
    if (key_resp_keysInst.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_keysInst.getKeys({keyList: ['space'], waitRelease: false});
      _key_resp_keysInst_allKeys = _key_resp_keysInst_allKeys.concat(theseKeys);
      if (_key_resp_keysInst_allKeys.length > 0) {
        key_resp_keysInst.keys = _key_resp_keysInst_allKeys[_key_resp_keysInst_allKeys.length - 1].name;  // just the last key pressed
        key_resp_keysInst.rt = _key_resp_keysInst_allKeys[_key_resp_keysInst_allKeys.length - 1].rt;
        key_resp_keysInst.duration = _key_resp_keysInst_allKeys[_key_resp_keysInst_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function instruction_keysRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('instruction_keys.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key_resp_keysInst.corr, level);
    }
    psychoJS.experiment.addData('key_resp_keysInst.keys', key_resp_keysInst.keys);
    if (typeof key_resp_keysInst.keys !== 'undefined') {  // we had a response
        psychoJS.experiment.addData('key_resp_keysInst.rt', key_resp_keysInst.rt);
        psychoJS.experiment.addData('key_resp_keysInst.duration', key_resp_keysInst.duration);
        routineTimer.reset();
        }
    
    key_resp_keysInst.stop();
...
function blank2000RoutineBegin(snapshot) {
  return async function () {
    ...
    blank2000Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function between_run_instLoopBegin(between_run_instLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    between_run_inst.forEach(function() {
...
function get_run_stim_listRoutineBegin(snapshot) {
  return async function () {
    ...
    // group A's logic: enc set 1 --> filler --> ret set1 -->  enc set 2
    if (expInfo["group"] ==='A'){
        if (expInfo["delay"] === 'short'){
            stim_list = ((((("stimuli/stim_lists/stimuli_list_sub_" + subnum) + "_set_1") + "_run_") + run.toString()) + ".csv");
            }else{
                if (expInfo["delay"] === 'long'){
                    stim_list = ((((("stimuli/stim_lists/stimuli_list_sub_" + subnum) + "_set_2") + "_run_") + run.toString()) + ".csv");
                    }
            }
        }
    
    console.log('stim list:',stim_list);
    
    
    // keep track of which components have finished
    get_run_stim_listComponents = [];
    
    get_run_stim_listComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function scene_item_presentationRoutineBegin(snapshot) {
  return async function () {
    ...
    scene_item_presentationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function congruency_responseRoutineBegin(snapshot) {
  return async function () {
    ...
    txt_qst = (((("Related (" + key_related.toUpperCase()) + ")\nor Unrelated (") + key_unrelated.toUpperCase()) + ")");
    ...
    congruency_responseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function is_last_runRoutineBegin(snapshot) {
  return async function () {
    ...
    is_last_runComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function between_run_pauseRoutineBegin(snapshot) {
  return async function () {
    ...
    between_run_pauseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function end_screenRoutineBegin(snapshot) {
  return async function () {
    ...
    if (expInfo['group']==='A' && expInfo['delay']==='short'){
        window.end_inst = 'Great job!\n\nTo continue to the next task, Press SPACEBAR, and then select "OK" in the prompted window - this will lead you to the next part of the experiment.';
        }else{
            window.end_inst = 'Great job! You are done with the first session of our experiment!\n\nIn three days, we will send you the link trhough Prolific massages to the second session of the experiment, and you will have 24 hours to complete it. If you would like to receive an email notification as well, please send us a massage with your email address.\n\nPress SPACEBAR and "OK" in the prompted window to receive the completion code for the current session.';
            }
...
function end_screenRoutineEachFrame() {
  return async function () {
    ...
    // *key_end* updates
    if (t >= 1 && key_end.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
...
function end_screenRoutineEnd(snapshot) {
  return async function () {
    ...
    key_end.stop();
    if (expInfo['group']==='A' && expInfo['delay']==='short'){
        completion_url = 'https://run.pavlovia.org/nitzanlubi/arithmetic_task_exp/?group=' 
            + expInfo['group'] 
