...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='Z:\\nitzan\\SBL\\sbl_superimposed_behavioral_Princeton\\encoding_superimposed_behav\\superimposed_SBL_encoding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisRun in runs:
        ...
        stim_list = "stimuli/stim_lists/stimuli_list_sub_" + subnum + "_run_" + str(run) + ".csv"
    ...
    end_inst = (
            ...
            "Press SPACEBAR to exit and notify researcher to next steps. "
        )
